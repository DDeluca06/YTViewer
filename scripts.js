...
function updateContent(category) {
  ...
  document.getElementById(
    "title"
  ).innerHTML = `<a href="${data.videoUrl}">${data.title}</a>`;
...
darkModeMediaQuery.addListener((e) => {
  // addListener is decepricated, we should use something else
...
savePreferenceButton.onclick = function () {
  ...
  const displayname = document.getElementById("disname").value;
